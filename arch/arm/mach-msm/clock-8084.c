...
static struct clk_lookup apq_clocks_8084[] = {
	...
	CLK_LOOKUP("iface_clk",	gcc_blsp1_ahb_clk.c,	"f991e000.uart"),
	...
	CLK_LOOKUP("core_clk",	gcc_blsp1_uart2_apps_clk.c,	"f991e000.uart"),
	...
	CLK_LOOKUP("ref_clk_src", rf_clk3.c,                "fc581000.sataphy"),
	CLK_LOOKUP("ref_clk_parent", pcie_1_phy_ldo.c,      "fc581000.sataphy"),
	...
	/* UFS clocks */
	CLK_LOOKUP("ref_clk", rf_clk1.c,                 "msm_ufs.1"),
	CLK_LOOKUP("bus_clk", gcc_sys_noc_ufs_axi_clk.c, "msm_ufs.1"),
	...
	CLK_LOOKUP("iface_clk", gcc_sys_noc_usb3_sec_axi_clk.c,
			"f9400000.ssusb"),
	CLK_LOOKUP("sleep_clk", gcc_usb30_sec_sleep_clk.c, "f9400000.ssusb"),
	...
	CLK_LOOKUP("core_clk", gcc_usb_hsic_ahb_clk.c, "msm_hsic_host"),
	CLK_LOOKUP("hsic_clk", gcc_usb_hsic_clk.c, "msm_hsic_host"),
	...
	CLK_LOOKUP("pwm_clk", div_clk2.c, "2-0048"),
  ...
  CLK_LOOKUP("cam_src_clk",	mclk2_clk_src.c, "a8.qcom,eeprom"),
  ...
  CLK_LOOKUP("cam_clk",	camss_mclk2_clk.c, "a8.qcom,eeprom"),
